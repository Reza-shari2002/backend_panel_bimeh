...
const create_form_schema = joi.object({
  ...
  document_car_type: joi.string().valid("0", "1" , "2").required(),
  ...
  plate_number : joi.string().trim().max(50).when("document_car_type",{is:"2" , then:joi.required() , otherwise:joi.allow("" , null).optional()}) , 
