...
async function find_users_data() {
  try {
    const query = " select phone_number   , payment_type , id , address , postal_code ,  plate_history_code , has_discount_transfer , has_active_insurance_transfer , is_relative_transfer  , plate_history_type  , document_car_type , full_name , created_at from forms ORDER BY created_at DESC";
